...
pub const BlockWriter = struct {
    ...
    bit_writer: BitWriter.BitWriter(.little),
    ...
    pub fn init(writer: *std.Io.Writer) Self {
        return .{
            .bit_writer = BitWriter.bitWriter(.little, writer),
    ...
    fn writeCode(self: *Self, c: hc.HuffCode) !void {
    ...
    fn storedHeader(self: *Self, length: usize, eof: bool) !void {
        assert(length <= 65535);
    ...
    fn fixedHeader(self: *Self, eof: bool) !void {
    ...
    pub fn write(self: *Self, tokens: []const Token, eof: bool, input: ?[]const u8) !void {
    ...
    pub fn storedBlock(self: *Self, input: []const u8, eof: bool) !void {
    ...
    pub fn huffmanBlock(self: *Self, input: []const u8, eof: bool) !void {
